...
- Run `yarn install` to install dependencies and run any required post-install scripts
  - **Warning:** Ensure you use `yarn install` to install dependencies and run any required post-install scripts. The normal install command will skip required post-install scripts, leaving your development environment in an invalid state.
